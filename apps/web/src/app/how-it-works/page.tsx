...
function FlowStep({
  ...
  return (
    <div className="rounded-lg border border-border-subtle bg-bg-secondary/40 p-5">
...
export default function HowItWorksPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-20">
      <p className="text-sm font-medium text-status-operational">How it works</p>
      ...
      <section className="mt-16 rounded-lg border border-border-subtle bg-bg-secondary/40 p-6">
