  ...
  return (
    <main>
      <section className="mx-auto max-w-6xl px-6 pb-16 pt-20 sm:pt-28">
        <p className="text-sm font-medium text-status-operational">
        ...
        <form action="/verify" className="mt-10 flex max-w-xl gap-2">
          <input
            ...
            required
            className="w-full rounded-md border border-border-subtle bg-bg-secondary px-4 py-2.5 text-sm text-text-primary placeholder:text-text-secondary focus:border-emerald-500 focus:outline-none"
          />
          <button
            type="submit"
            className="shrink-0 rounded-md bg-status-operational px-5 py-2.5 text-sm font-semibold text-slate-950 transition hover:bg-status-operational"
          >
            Check any anchor
          </button>
        </form>
        <p className="mt-3 text-sm text-text-secondary">
          ...
          <Link href="/directory" className="text-text-primary underline underline-offset-2">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {previewAnchors.map((anchor) => (
                <Link
                  ...
                  className="block rounded-lg border border-border-subtle bg-bg-primary p-5 transition hover:border-border-subtle"
                >
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-8 sm:grid-cols-3">
          <div>
            <p className="text-sm font-medium text-text-primary">Free, on a schedule</p>
          ...
          <div>
            <p className="text-sm font-medium text-text-primary">Paid, on demand</p>
            <p className="mt-2 text-sm text-text-secondary">
          ...
          <div>
            <p className="text-sm font-medium text-text-primary">Built for agents too</p>
            <p className="mt-2 text-sm text-text-secondary">
